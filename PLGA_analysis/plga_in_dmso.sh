...
declare -a mol_n
mol_n=(1406 1406 2320 4326 8448)
...
#		echo "Other           ${mol_n[counter]}" >> topol.top
#		sed -i '23i\; Include DMSO parameters' topol.top 
#		sed -i '24i\#include "/suppscr/pfaendtner/cnyambura/NEE_home/BSA_Nano_Prep/pure_dmso/dmso.itp"' topol.top
